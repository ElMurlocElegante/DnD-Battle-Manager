...
inic_pool = pd.DataFrame(columns=['Character','Iniciativa','Vida','Succes','Failure'])
character_data_structure = read_pc_data()

slow_print('\nPor favor, ingrese las tiradas del jugador citado:\n',0.03)
inic_pool = inic_call_char(inic_pool,character_data_structure)
slow_print('Estadísticas de Jugadores cargada, inicializando',0.01)
slow_print('.....\n',0.5)
slow_print(f'{inic_pool}\n',0.001)
while True:
