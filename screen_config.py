...
left_scr_up_out.box()
right_scr_out.box()
right_scr_out.addstr(0,int(mit_ancho*0.5-10),'╖ Orden de Combate ╓')
right_scr_out.addstr(1,int(mit_ancho*0.5-10),'╚══════════════════╝')
left_scr_up_out.addstr(0,int(mit_ancho*0.5-4),'╖ Menu ╓')
left_scr_up_out.addstr(1,int(mit_ancho*0.5-4),'╚══════╝')
left_scr_dw_out.addstr(0,int(mit_ancho*0.5-11),'╖ Registro de Combate ╓')
left_scr_dw_out.addstr(1,int(mit_ancho*0.5-11),'╚═════════════════════╝')
